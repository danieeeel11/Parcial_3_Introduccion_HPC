...
std::vector<std::vector<std::string>> ExtractionData::LeerCSV(){
    /*En primer lugar se abre y se almacena el fichero en un buffer temporal "archivo"*/
    ...
    while(getline(archivo,linea)){
        ...
        //Se divide o segmenta cada elemeno con boost
...
/*
 * Cuando el programador no esta seguro cual es el tipo de dato va a regresar la funcio
 * Se utiliza auto "nombre_funcion" decltype
 */
